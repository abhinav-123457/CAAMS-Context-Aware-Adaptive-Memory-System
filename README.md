...
|
|-- Core logic (used by MCP server and harnesses)
...
|
|-- Evaluation harnesses (single process, LangGraph)
...
|-- data/android_usage.csv           # LSApp (generated by data_loader.py)
|-- data/melbourne_context.csv       # Melbourne parking (generated)
|-- data/kv_cache_workloads.csv      # ShareGPT workloads (generated)
|
|-- models/
